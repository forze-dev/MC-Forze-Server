...
/**
 * @route GET /api/rewards/player/:telegramId
...
/**
 * @route GET /api/rewards/top/all-time
...
/**
 * @route GET /api/rewards/current-active-time
...
/**
 * @route POST /api/rewards/trigger-manual
